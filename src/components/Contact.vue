<template lang="">
    <div id="footer" class="p-12 pb-0 text-white bg-gradient-to-r from-blue-900 to-purple-900 flex flex-row flex-wrap">
        ...
        <span class="mt-6 mb-2 w-full text-center font-semibold">Josua-aliansa</span>
    </div>
</template>
<script>
export default {
