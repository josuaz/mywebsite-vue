<template lang="">
    <div id="about" class="min-h-screen text-white bg-gradient-to-r from-blue-900 to-purple-900 p-2 lg:p-16 lg:pb-2 flex flex-row flex-wrap">
        <div class="w-full lg:w-1/2 mb-4 lg:mb-0 p-1">
            <img src="https://picsum.photos/500/400" class="h-full rounded-lg" alt="">
        </div>
        <div class="w-full lg:w-1/2 flex flex-col p-1">
            ...
            <div class="w-full mt-auto">
                ...
                <div class="flex justify-around lg:justify-start flex-row flex-wrap mt-5 lg:mt-0">
                    ...
                    <a href="https://www.linkedin.com/in/joshua-aliansa/" target="_blank">
                        <button class="p-2 rounded-full hover:bg-white/20 duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="h-8 w-8" viewBox="0 0 16 16">
                    ...
                    <a href="https://github.com/josuaz" target="_blank">
                        <button class="p-2 rounded-full hover:bg-white/20 duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="h-8 w-8" viewBox="0 0 16 16">
                    ...
                    <a href="https://twitter.com/joshuaaliansa" target="_blank">
                        <button class="p-2 rounded-full hover:bg-white/20 duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="h-8 w-8" viewBox="0 0 16 16">
